...
class Custom_Post_Types
{
    ...
    {
        add_action( 'init', [$this, 'register_tour_cpt_and_taxonomy'] );
        add_action('add_meta_boxes', [$this, 'tour_add_meta_boxes']);
        add_action('save_post', [$this, 'tour_save_meta_box_data']);
    }
    /**
     * Register Custom Post Type: Tour
     * Register Custom Taxonomy: Tour Type (Single-Day, Multi-Day)
     */
    public function register_tour_cpt_and_taxonomy() {
     ...
     */
    public function tour_add_meta_boxes() {
        add_meta_box(
            'tour_details_box',
            'Tour Details',
            [$this, 'tour_details_box_callback'],
            'tour',
            'normal',
            'high'
        );
     ...
     */
    public function tour_details_box_callback($post) {
     ...
     * Save Meta Box Data
     */
    public function tour_save_meta_box_data($post_id) {
